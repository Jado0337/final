 ...
 * strings.
 *
 * The input is an array of  strings to start analysis from, and an object
...
kernel.module.loader = def(
  ...
  function (analyser) {
    var load = function (s, deps, fetcher, oncontinue, onsuccess, onerror) {
      var result = analyser.analyse(s, deps);
