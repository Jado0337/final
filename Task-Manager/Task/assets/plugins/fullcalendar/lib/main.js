...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var RenderHook = /** @class */ (function (_super) {
        ...
        RenderHook.prototype.render = function () {
            ...
            return (createElement(MountHook, { hookProps: hookProps, didMount: props.didMount, willUnmount: props.willUnmount, elRef: this.handleEl }, function (ElRef) { return (createElement(ContentHook, { hookProps: hookProps, content: props.content, defaultContent: props.defaultContent, backupElRef: _this.ElRef }, function (innerElRef, innerContent) { return props.children(ElRef, normalizeClassNames(props.classNames, hookProps), innerElRef, innerContent); })); }));
        };
        return RenderHook;
    }(BaseComponent));
    ...
    var MountHook = /** @class */ (function (_super) {
        ...
        MountHook.prototype.render = function () {
            return this.props.children(this.handleEl);
        };
        MountHook.prototype.componentDidMount = function () {
            var callback = this.props.didMount;
            if (callback) {
                callback(__assign(__assign({}, this.props.hookProps), { el: this.El }));
            }
        };
    ...
    var View = /** @class */ (function (_super) {
        ...
        View.prototype.render = function () {
            ...
            return (createElement(MountHook, { hookProps: hookProps, didMount: options.viewDidMount, willUnmount: options.viewWillUnmount, elRef: props.elRef }, function (ElRef) { return props.children(ElRef, ["fc-" + props.viewSpec.type + "-view", 'fc-view'].concat(customClassNames)); }));
        };
        return View;
    }(BaseComponent));
    ...
    function createViewHookComponent(options) {
        return function (viewProps) { return (createElement(ViewContextType.Consumer, null, function (context) { return (createElement(View, { viewSpec: context.viewSpec }, function (viewElRef, viewClassNames) {
            var hookProps = __assign(__assign({}, viewProps), { nextDayThreshold: context.options.nextDayThreshold });
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.classNames, content: options.content, didMount: options.didMount, willUnmount: options.willUnmount, elRef: viewElRef }, function (ElRef, customClassNames, innerElRef, innerContent) { return (createElement("div", { className: viewClassNames.concat(customClassNames).join(' '), ref: ElRef }, innerContent)); }));
        })); })); };
    }
    ...
    */
    ...
    /*
    this array is exposed on the  namespace so that UMD plugins can add to it.
    ...
    */
    ...
    var TableDateCell = /** @class */ (function (_super) {
        ...
        TableDateCell.prototype.render = function () {
            ...
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.dayHeaderClassNames, content: options.dayHeaderContent, defaultContent: renderInner, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount }, function (ElRef, customClassNames, innerElRef, innerContent) { return (createElement("th", __assign({ ref: ElRef, className: classNames.concat(customClassNames).join(' '), "data-date": !dayMeta.isDisabled ? formatDayString(date) : undefined, colSpan: props.colSpan }, props.extraDataAttrs),
    ...
    */
    ...
    var Event = /** @class */ (function (_super) {
        ...
        Event.prototype.render = function () {
            ...
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.eventClassNames, content: options.eventContent, defaultContent: props.defaultContent, didMount: options.eventDidMount, willUnmount: options.eventWillUnmount, elRef: this.elRef }, function (ElRef, customClassNames, innerElRef, innerContent) { return props.children(ElRef, standardClassNames.concat(customClassNames), innerElRef, innerContent, hookProps); }));
        };
        ...
        */
        Event.prototype.componentDidUpdate = function (prevProps) {
    ...
    var StandardEvent = /** @class */ (function (_super) {
        ...
        StandardEvent.prototype.render = function () {
            ...
            return (createElement(Event, { seg: seg, timeText: timeText, disableDragging: props.disableDragging, disableResizing: props.disableResizing, defaultContent: props.defaultContent || renderInnerContent, isDragging: props.isDragging, isResizing: props.isResizing, isDateSelecting: props.isDateSelecting, isSelected: props.isSelected, isPast: props.isPast, isFuture: props.isFuture, isToday: props.isToday }, function (ElRef, classNames, innerElRef, innerContent, hookProps) { return (createElement("a", __assign({ className: props.extraClassNames.concat(classNames).join(' '), style: {
                    borderColor: hookProps.borderColor,
                    backgroundColor: hookProps.backgroundColor,
                }, ref: ElRef }, getSegAnchorAttrs(seg)),
    ...
    var NowIndicator = function (props) { return (createElement(ViewContextType.Consumer, null, function (context) {
        var options = context.options;
        var hookProps = {
            isAxis: props.isAxis,
    ...
    var DayCell = /** @class */ (function (_super) {
        ...
        DayCell.prototype.render = function () {
            ...
            return (createElement(MountHook, { hookProps: hookProps, didMount: options.dayCellDidMount, willUnmount: options.dayCellWillUnmount, elRef: props.elRef }, function (ElRef) { return props.children(ElRef, classNames, dataAttrs, hookProps.isDisabled); }));
        };
        return DayCell;
    }(BaseComponent));
    ...
    var BgEvent = function (props) { return (createElement(Event, { defaultContent: renderInnerContent$1, seg: props.seg /* uselesss i think */, timeText: "", disableDragging: true, disableResizing: true, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: false, isPast: props.isPast, isFuture: props.isFuture, isToday: props.isToday }, function (ElRef, classNames, innerElRef, innerContent, hookProps) { return (createElement("div", { ref: ElRef, className: ['fc-bg-event'].concat(classNames).join(' '), style: {
            backgroundColor: hookProps.backgroundColor,
        } }, innerContent)); })); };
    ...
    var WeekNumber = function (props) { return (createElement(ViewContextType.Consumer, null, function (context) {
        var dateEnv = context.dateEnv, options = context.options;
        var date = props.date;
        ...
        function Calendar(el, optionOverrides) {
            ...
            _this.handleRenderRequest = function () {
                if (_this.isRendering) {
                    ...
                    render(createElement(Calendar, { options: currentData_1.calendarOptions, theme: currentData_1.theme, emitter: currentData_1.emitter }, function (classNames, height, isHeightAuto, forPrint) {
    ...
    */
    ...
    var TableView = /** @class */ (function (_super) {
        ...
        TableView.prototype.renderSimpleLayout = function (headerRowContent, bodyContent) {
            ...
            return (createElement(View, { viewSpec: context.viewSpec }, function (ElRef, classNames) { return (createElement("div", { ref: ElRef, className: ['fc-daygrid'].concat(classNames).join(' ') },
    ...
    var TableCell = /** @class */ (function (_super) {
        ...
        TableCell.prototype.render = function () {
            ...
            var navLinkAttrs = options.navLinks
                ...
                : {};
            return (createElement(DayCell, { date: date, dateProfile: dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, elRef: this.handleEl }, function (dayElRef, dayClassNames, DataAttrs, isDisabled) { return (createElement("td", __assign({ ref: dayElRef, className: ['fc-daygrid-day'].concat(dayClassNames, props.extraClassNames || []).join(' ') }, DataAttrs, props.extraDataAttrs),
                createElement("div", { className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner", ref: props.innerElRef /* different from hook system! RENAME */ },
                    props.showWeekNumber && (createElement(WeekNumber, { date: date, defaultFormat: DEFAULT_WEEK_NUM_FORMAT }, function (weekElRef, weekClassNames, innerElRef, innerContent) { return (createElement("a", __assign({ ref: weekElRef, className: ['fc-daygrid-week-number'].concat(weekClassNames).join(' ') }, navLinkAttrs), innerContent)); })),
                    ...
                    createElement("div", { className: "fc-daygrid-day-events", ref: props.fgContentElRef, style: { paddingBottom: props.fgPaddingBottom } },
                        ...
                        Boolean(props.moreCnt) && (createElement("div", { className: "fc-daygrid-day-bottom", style: { marginTop: props.moreMarginTop } },
                            createElement(RenderHook, { hookProps: hookProps, classNames: options.moreLinkClassNames, content: options.moreLinkContent, defaultContent: renderMoreLinkInner, didMount: options.moreLinkDidMount, willUnmount: options.moreLinkWillUnmount }, function (ElRef, classNames, innerElRef, innerContent) { return (createElement("a", { ref: ElRef, className: ['fc-daygrid-more-link'].concat(classNames).join(' '), onClick: _this.handleMoreLinkClick }, innerContent)); })))),
    ...
    var TableListItemEvent = /** @class */ (function (_super) {
        ...
        TableListItemEvent.prototype.render = function () {
            ...
            return (createElement(Event, { seg: props.seg, timeText: timeText, defaultContent: renderInnerContent$2, isDragging: props.isDragging, isResizing: false, isDateSelecting: false, isSelected: props.isSelected, isPast: props.isPast, isFuture: props.isFuture, isToday: props.isToday }, function (ElRef, classNames, innerElRef, innerContent) { return ( // we don't use styles!
            createElement("a", __assign({ className: ['fc-daygrid-event', 'fc-daygrid-dot-event'].concat(classNames).join(' '), ref: ElRef }, getSegAnchorAttrs$1(props.seg)), innerContent)); }));
        };
    ...
    */
        ...
        TableRow.prototype.render = function () {
            ...
            var selectedInstanceHash = // TODO: messy way to compute this
             (props.eventDrag && props.eventDrag.affectedInstances) ||
                ...
                {};
            return (createElement("tr", { ref: this.ElRef },
        ...
        TableRow.prototype.updateSizing = function (isExternalSizingChange) {
            ...
            if (props.clientWidth !== null) { // positioning ready?
                if (isExternalSizingChange) {
                    ...
                    if (frameEls.length) {
                        var originEl = this.ElRef.current;
                        this.setState({
    ...
    var Popover = /** @class */ (function (_super) {
        ...
        function Popover() {
            ...
            _this.handleDocumentMousedown = function (ev) {
                ...
                if (onClose && !_this.El.contains(ev.target)) {
                    onClose();
                }
            };
        ...
        Popover.prototype.render = function () {
            ...
            return (createElement("div", __assign({ className: classNames.join(' ') }, props.extraAttrs, { ref: this.handleEl }),
        ...
        */
        Popover.prototype.updateSize = function () {
            ...
            var dims = El.getBoundingClientRect(); // only used for width,height
            ...
            applyStyle(El, { top: top, left: left });
        };
        return Popover;
    }(BaseComponent));
    ...
    var MorePopover = /** @class */ (function (_super) {
        ...
        MorePopover.prototype.render = function () {
            ...
            return (createElement(DayCell, { date: date, dateProfile: dateProfile, todayRange: todayRange, elRef: this.ElRef }, function (ElRef, dayClassNames, dataAttrs) { return (createElement(Popover, { elRef: ElRef, title: title, extraClassNames: ['fc-more-popover'].concat(dayClassNames), extraAttrs: dataAttrs, onClose: props.onCloseClick, alignmentEl: props.alignmentEl, topAlignmentEl: props.topAlignmentEl },
    ...
    var Table = /** @class */ (function (_super) {
        ...
        Table.prototype.render = function () {
            ...
            return (createElement("div", { className: classNames.join(' '), ref: this.handleEl, style: {
        ...
        Table.prototype.prepareHits = function () {
            this.rowPositions = new PositionCache(this.El, this.rowRefs.collect().map(function (rowObj) { return rowObj.getCellEls()[0]; }), // first cell el in each row. TODO: not optimal
            false, true);
            this.colPositions = new PositionCache(this.El, this.rowRefs.currentMap[0].getCellEls(), // cell els in first row
            true, // horizontal
            false);
        };
        Table.prototype.positionToHit = function (leftPosition, topPosition) {
            var morePopover = this.morePopoverRef.current;
            var morePopoverHit = morePopover ? morePopover.positionToHit(leftPosition, topPosition, this.El) : null;
            var morePopoverState = this.state.morePopoverState;
            if (morePopoverHit) {
    ...
    function TimeColsAxisCell(props) {
        ...
        return (createElement(ViewContextType.Consumer, null, function (context) {
            ...
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.slotLabelClassNames, content: options.slotLabelContent, defaultContent: renderInnerContent$3, didMount: options.slotLabelDidMount, willUnmount: options.slotLabelWillUnmount }, function (ElRef, customClassNames, innerElRef, innerContent) { return (createElement("td", { ref: ElRef, className: classNames.concat(customClassNames).join(' '), "data-time": props.isoTimeStr },
    ...
    var TimeColsView = /** @class */ (function (_super) {
        ...
        function TimeColsView() {
            ...
            _this.renderHeadAxis = function (rowKey, frameHeight) {
                ...
                if (options.weekNumbers && rowKey === 'day') {
                    return (createElement(WeekNumber, { date: range.start, defaultFormat: DEFAULT_WEEK_NUM_FORMAT$1 }, function (ElRef, classNames, innerElRef, innerContent) { return (createElement("th", { ref: ElRef, className: [
                            'fc-timegrid-axis',
            ...
            _this.renderTableRowAxis = function (rowHeight) {
                ...
                createElement(RenderHook, { hookProps: hookProps, classNames: options.allDayClassNames, content: options.allDayContent, defaultContent: renderAllDayInner, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount }, function (ElRef, classNames, innerElRef, innerContent) { return (createElement("td", { ref: ElRef, className: [
                        'fc-timegrid-axis',
                        'fc-scrollgrid-shrink',
                    ].concat(classNames).join(' ') },
        ...
        TimeColsView.prototype.renderSimpleLayout = function (headerRowContent, allDayContent, timeContent) {
            ...
            return (createElement(View, { viewSpec: context.viewSpec, elRef: this.ElRef }, function (ElRef, classNames) { return (createElement("div", { className: ['fc-timegrid'].concat(classNames).join(' '), ref: ElRef },
                            ...
                            createElement("div", { className: "fc-timegrid-now-indicator-container" },
                                createElement(NowTimer, { unit: isNowIndicator ? 'minute' : 'day' /* hacky */ }, function (nowDate) {
                                    ...
                                    if (typeof nowIndicatorTop === 'number') {
                                        return (createElement(NowIndicator, { isAxis: true, date: nowDate }, function (ElRef, classNames, innerElRef, innerContent) { return (createElement("div", { ref: ElRef, className: ['fc-timegrid-now-indicator-arrow'].concat(classNames).join(' '), style: { top: nowIndicatorTop } }, innerContent)); }));
                                    }
                                    return null;
                                })))); },
                    },
        ...
        TimeColsSlatsBody.prototype.render = function () {
            ...
            return (createElement("tbody", null, props.slatMetas.map(function (slatMeta, i) {
                ...
                return (createElement("tr", { key: slatMeta.key, ref: slatElRefs.createRef(slatMeta.key) },
                    ...
                    createElement(RenderHook, { hookProps: hookProps, classNames: options.slotLaneClassNames, content: options.slotLaneContent, didMount: options.slotLaneDidMount, willUnmount: options.slotLaneWillUnmount }, function (ElRef, customClassNames, innerElRef, innerContent) { return (createElement("td", { ref: ElRef, className: classNames.concat(customClassNames).join(' '), "data-time": slatMeta.isoTimeStr }, innerContent)); })));
            })));
        };
    ...
    */
    var TimeColsSlats = /** @class */ (function (_super) {
        ...
        TimeColsSlats.prototype.render = function () {
            var _a = this, props = _a.props, context = _a.context;
            return (createElement("div", { className: "fc-timegrid-slots", ref: this.ElRef },
        ...
        TimeColsSlats.prototype.updateSizing = function () {
            ...
            if (props.onCoords &&
                ...
                var El = this.ElRef.current;
                if (El.offsetHeight) { // not hidden by css
                    props.onCoords(new TimeColsSlatsCoords(new PositionCache(this.ElRef.current, collectSlatEls(this.slatElRefs.currentMap, props.slatMetas), false, true), this.props.dateProfile, context.options.slotDuration));
                }
            }
        };
    ...
    var TimeCol = /** @class */ (function (_super) {
        ...
        TimeCol.prototype.render = function () {
            ...
            var interactionAffectedInstances = // TODO: messy way to compute this
             (props.eventDrag && props.eventDrag.affectedInstances) ||
                (props.eventResize && props.eventResize.affectedInstances) ||
                {};
            return (createElement(DayCell, { elRef: props.elRef, date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraHookProps: props.extraHookProps }, function (ElRef, classNames, dataAttrs) { return (createElement("td", __assign({ ref: ElRef, className: ['fc-timegrid-col'].concat(classNames, props.extraClassNames || []).join(' ') }, dataAttrs, props.extraDataAttrs),
        ...
        TimeCol.prototype.renderNowIndicator = function (segs) {
            ...
            return segs.map(function (seg, i) { return (createElement(NowIndicator, { isAxis: false, date: date,
                // key doesn't matter. will only ever be one
                key: i }, function (ElRef, classNames, innerElRef, innerContent) { return (createElement("div", { ref: ElRef, className: ['fc-timegrid-now-indicator-line'].concat(classNames).join(' '), style: { top: slatCoords.computeDateTop(seg.start, date) } }, innerContent)); })); });
        };
    ...
    var TimeColsContent = /** @class */ (function (_super) {
        ...
        TimeColsContent.prototype.render = function () {
            ...
            return (createElement("div", { className: "fc-timegrid-cols", ref: this.ElRef },
                    ...
                    createElement("tbody", null,
                        createElement("tr", null,
                            props.axis && (createElement("td", { className: "fc-timegrid-col fc-timegrid-axis" },
                                createElement("div", { className: "fc-timegrid-col-frame" },
                                    createElement("div", { className: "fc-timegrid-now-indicator-container" }, typeof nowIndicatorTop === 'number' && (createElement(NowIndicator, { isAxis: true, date: props.nowDate }, function (ElRef, classNames, innerElRef, innerContent) { return (createElement("div", { ref: ElRef, className: ['fc-timegrid-now-indicator-arrow'].concat(classNames).join(' '), style: { top: nowIndicatorTop } }, innerContent)); })))))),
        ...
        TimeColsContent.prototype.updateCoords = function () {
            ...
            if (props.onColCoords &&
                ...
                props.onColCoords(new PositionCache(this.ElRef.current, collectCellEls(this.cellElRefs.currentMap, props.cells), true, // horizontal
                false));
            }
        };
    ...
    var TimeCols = /** @class */ (function (_super) {
        ...
        TimeCols.prototype.render = function () {
            var _a = this, props = _a.props, state = _a.state;
            return (createElement("div", { className: "fc-timegrid-body", ref: props.ElRef, style: {
                    // these props are important to give this wrapper correct dimensions for interactions
                    // TODO: if we set it here, can we avoid giving to inner tables?
                    width: props.clientWidth,
                    minWidth: props.tableMinWidth,
    ...
    var DayTimeCols = /** @class */ (function (_super) {
        ...
        DayTimeCols.prototype.render = function () {
            ...
            return (createElement(NowTimer, { unit: isNowIndicator ? 'minute' : 'day' }, function (nowDate, todayRange) { return (createElement(TimeCols, __assign({ ref: _this.timeColsRef, ElRef: _this.handleEl }, _this.slicer.sliceProps(props, dateProfile, null, context, dayRanges), { forPrint: props.forPrint, axis: props.axis, dateProfile: dateProfile, slatMetas: props.slatMetas, slotDuration: props.slotDuration, cells: dayTableModel.cells[0], tableColGroupNode: props.tableColGroupNode, tableMinWidth: props.tableMinWidth, clientWidth: props.clientWidth, clientHeight: props.clientHeight, expandRows: props.expandRows, nowDate: nowDate, nowIndicatorSegs: isNowIndicator && _this.slicer.sliceNowDate(nowDate, context, dayRanges), todayRange: todayRange, onScrollTopRequest: props.onScrollTopRequest, onSlatCoords: props.onSlatCoords }))); }));
        };
    ...
    var ListViewHeaderRow = /** @class */ (function (_super) {
        ...
        ListViewHeaderRow.prototype.render = function () {
            ...
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.dayHeaderClassNames, content: options.dayHeaderContent, defaultContent: renderInnerContent$4, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount }, function (ElRef, customClassNames, innerElRef, innerContent) { return (createElement("tr", { ref: ElRef, className: classNames.concat(customClassNames).join(' '), "data-date": formatDayString(dayDate) },
    ...
    var ListViewEventRow = /** @class */ (function (_super) {
        ...
        ListViewEventRow.prototype.render = function () {
            ...
            return (createElement(Event, { seg: seg, timeText: "" // BAD. because of all-day content
                , disableDragging: true, disableResizing: true, defaultContent: renderEventInnerContent, isPast: props.isPast, isFuture: props.isFuture, isToday: props.isToday, isSelected: props.isSelected, isDragging: props.isDragging, isResizing: props.isResizing, isDateSelecting: props.isDateSelecting }, function (ElRef, classNames, innerElRef, innerContent, hookProps) { return (createElement("tr", { className: ['fc-list-event', hookProps.event.url ? 'fc-event-forced-url' : ''].concat(classNames).join(' '), ref: ElRef },
    ...
    function buildTimeContent(seg, timeFormat, context) {
        ...
        if (options.displayEventTime !== false) {
            ...
            if (doAllDay) {
                ...
                return (createElement(RenderHook, { hookProps: hookProps, classNames: options.allDayClassNames, content: options.allDayContent, defaultContent: renderAllDayInner$1, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount }, function (ElRef, classNames, innerElRef, innerContent) { return (createElement("td", { className: ['fc-list-event-time'].concat(classNames).join(' '), ref: ElRef }, innerContent)); }));
            }
    ...
    */
    var ListView = /** @class */ (function (_super) {
        ...
        ListView.prototype.render = function () {
            ...
            return (createElement(View, { viewSpec: context.viewSpec, elRef: this.setEl }, function (ElRef, classNames) { return (createElement("div", { ref: ElRef, className: extraClassNames.concat(classNames).join(' ') },
        ...
        ListView.prototype.renderEmptyMessage = function () {
            ...
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.noEventsClassNames, content: options.noEventsContent, defaultContent: renderNoEventsInner, didMount: options.noEventsDidMount, willUnmount: options.noEventsWillUnmount }, function (ElRef, classNames, innerElRef, innerContent) { return (createElement("div", { className: ['fc-list-empty'].concat(classNames).join(' '), ref: ElRef },
