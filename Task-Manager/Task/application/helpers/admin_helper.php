...
function _maybe_system_setup_warnings()
{
    ...
    // Check if there is index.html file in the  crm directory, on some servers if this file exists eq default server index.html file the authentication/login page may not work properly
