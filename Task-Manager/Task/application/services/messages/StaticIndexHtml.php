...
/**
 * Check if there is index.html file in the  crm directory eq default server index.html
...
class StaticIndexHtml extends AbstractMessage
{
    ...
    {
        ?>
		<h4>Static <b>index.html</b> file detected in the CRM  directory!</h4>
		The system detected static <b>index.html</b> file in the CRM  directory (<?php echo FCPATH; ?>)
		<br />
