...
class elFinderVolumeMySQL extends elFinderVolumeDriver
{
     ...
     * Connect to db, check required tables and fetch  path
     *
     * @return bool
     * @author Dmitry (dio) Levashov
     **/
    ...
    {
        return ($stat = $this->stat($path)) ? (!empty($stat['phash']) ? $this->decode($stat['phash']) : $this->) : false;
    }
