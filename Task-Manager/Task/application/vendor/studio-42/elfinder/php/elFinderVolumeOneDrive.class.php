...
class elFinderVolumeOneDrive extends elFinderVolumeDriver
{
    ...
    public function __construct()
    {
        $opts = array(
            ...
            'tmpPath' => '',
            'acceptedName' => '#^[^/\\?*:|"<>]*[^./\\?*:|"<>]$#',
            'CssClass' => 'elfinder-navbar--onedrive',
    ...
    protected function init()
    {
        ...
        $this->options[''] = ($this->options[''] == '')? 'OneDrive.com' : $this->options[''];
    ...
    protected function _copy($source, $targetDir, $name)
    {
        ...
        try {
            ...
            if ($parentId === '') {
                $properties['parentReference'] = (object)array('path' => '/drive/:');
            } else {
