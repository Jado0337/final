...
{
    /**
     * arrays passed to this method should have a single  element
    ...
    public static function arrayToXml($aData)
    {
        ...
        // create the body
        self::_createElementsFromArray($writer, $aData[$ElementName], $ElementName);

        // close the  element and document
        $writer->endElement();
        $writer->endDocument();
