...
$lang['utility_db_backup_note']          = 'Примечание: Из-за ограничений времени выполнения и памяти доступных для PHP, резервное копирование очень больших баз данных может оказаться невозможным. Если ваша база данных очень велика, вам может потребоваться резервное копирование непосредственно с вашего SQL-сервера через командную строку, а если у вас нет -привилегий, попросите администратора вашего сервера сделать это для вас.';
