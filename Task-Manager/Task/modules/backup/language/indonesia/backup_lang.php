...
$lang['utility_db_backup_note']          = 'Catatan: Karena waktu eksekusi dan memori yang tersedia untuk PHP terbatas, back up database yang sangat besar mungkin tidak dapat dilakukan. Jika database Anda sangat besar Anda mungkin perlu untuk backup langsung dari SQL server Anda melalui baris perintah, atau minta admin server Anda melakukannya untuk Anda jika Anda tidak memiliki hak akses .';
