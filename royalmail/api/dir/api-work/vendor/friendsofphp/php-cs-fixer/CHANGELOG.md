...
* bug #5598 GroupImportFixer - fix breaking code when fixing  classes (Leprechaunz)
...
* minor #4643 DX: Update .gitattributes and move ci-integration.sh to  of the project (kubawerlos, keradus)
...
* minor #2499 FileSpecificCodeSample - Specify class name relative to  namespace (localheinz, keradus)
...
* minor #1392 Add report to XML report as the  node (junichi11)
