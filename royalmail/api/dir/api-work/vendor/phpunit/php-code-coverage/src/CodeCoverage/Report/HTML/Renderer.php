...
abstract class PHP_CodeCoverage_Report_HTML_Renderer
{
    ...
    protected function getInactiveBreadcrumb(PHP_CodeCoverage_Report_Node $node, $pathTo)
    {
        return sprintf(
    ...
    protected function getPathTo(PHP_CodeCoverage_Report_Node $node)
    {
        $id    = $node->getId();
