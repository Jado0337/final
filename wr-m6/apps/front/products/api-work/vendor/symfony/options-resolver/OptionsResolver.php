...
class OptionsResolver implements Options
{
     ...
     * @return $this
     *
     * @throws AccessException If called from a lazy option, a normalizer or a  definition
     */
    public function setPrototype(bool $prototype): self
    {
        ...
        if (null === $this->prototype && $prototype) {
            throw new AccessException('The prototype property cannot be set from a  definition.');
        }
