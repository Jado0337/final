    ...
    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
        <article class="hoproduct ">
            <div class="hoproduct-image text-center">
                ...
                <a class="hoproduct-thumb text-center" style="cursor: pointer;" data-toggle="modal" data-target="#exampleModalCenter" data-product-name="<?php echo $arr['productname']; ?>" data-product-img="<?php echo 'wr-m6/updated/'.str_replace(' ','-',$arr['productname']).'.webp'; ?>">
                    <?php if(file_exists('wr-m6/updated/'.str_replace(' ','-',$arr['productname']).'.webp')) { ?>
                        <img class="hoproduct-frontimage text-center btn-opn" src="wr-m6/updated/<?php echo str_replace(' ','-',$arr['productname']); ?>.webp" alt="Sell <?php echo $arr['productname']; ?>">
                    <?php } else { ?>
                        <img class="btn-opn hoproduct-frontimage text-center" src="wr-m6/updated/notavailable.webp" alt="Sell <?php echo $arr['productname']; ?>">
                    <?php } ?>
                </a>

                <h2 class="qv-name" style="color:#333333; font-size:12px; margin-top:20px;"><?php echo $arr['productname']; ?></h2>
                ...
                foreach ($record2 as $arr2) { ?>
                    <a style="background-color:#13564f;" href="product-view.php?name=<?php echo str_replace(' ','-',$arr['productname']);?>&pid=<?php echo $arr['id']; ?>&vid=<?php echo $arr2['variant']; ?>" class="btn btn-success btn-sm text-white" style="margin-bottom:5px;"><?php echo $this->getProductVariant($arr2['variant']); ?></a>
                <?php } ?>
                </div>
